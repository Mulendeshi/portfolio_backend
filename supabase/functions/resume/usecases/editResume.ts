 ...
 * EditResume Use Case
 */
export class EditResumeUsecase {
  constructor(private readonly repository: any) {}

  async execute(data: EditResumePayload): Promise<ProjectType> {
    logExec("Executing EditResume use case", data);
    ...
    try {
      ...
      // const result = await this.repository.getRecordById({table:"projects",id:id});
      ...
      const updatedProject = await this.repository.updateRecord(updateProjectQuery);
